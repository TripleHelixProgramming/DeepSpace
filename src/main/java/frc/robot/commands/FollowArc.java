...
public class FollowArc extends Command {
	...
	public FollowArc(FollowsArc drivetrain, SrxTrajectory trajectory) {
		this(drivetrain, trajectory, false, false, false);
	}

	public FollowArc(FollowsArc drivetrain, SrxTrajectory trajectory, 
			boolean flipLeftAndRight, boolean flipRobot, boolean flipPath) {
	...
	protected void initialize() {
		...
		loadBuffer(trajectory, drivetrain.getDistance(), flipLeftAndRight, flipRobot, flipPath);
	...
	private void loadBuffer(SrxTrajectory trajectory, double startPosition, boolean flipLeftAndRight, boolean flipRobot, boolean flipPath) {
